...
function keykey(e) {
  if (now() > nextMove) {
    if (e === 37) {
      $("#fielding").animate({left: "-="+dist}, {easing: ez, queue: q, duration: dur});
      nextMove = next(100);

      $("#fielding").css('-webkit-animation-name', function() {
        return "sprite-walking-left";                               // change sprite animation to face left
      });

    } else if( e === 38 ) {
      $("#fielding").animate({top: "-="+dist}, {easing: ez, queue: q, duration: dur});
      nextMove = next(100);
      $("#fielding").css('-webkit-animation-name', function() {
        return "sprite-walking-up";                                 // change sprite animation to face up
      });
      ...
      nextMove = next(100);
      $("#fielding").css('-webkit-animation-name', function() {
        return "sprite-walking-right";                              // change sprite animation to face right
      });
      ...
      nextMove = next(100);
      $("#fielding").css('-webkit-animation-name', function() {
        return "sprite-walking-down";                               // change sprite animation to face down
      });
    }
  }
}

function keybyebye(e) {
  ...
  switch(e) {
    case 37:
      $("#fielding").stop();
      $("#fielding").css('-webkit-animation-name', function() {
        return "sprite-standing-left";
      });
      break;
    case 38:
      $("#fielding").stop();
      $("#fielding").css('-webkit-animation-name', function() {
        return "sprite-standing-upward";
      });
      break;
    case 39:
      $("#fielding").stop();
      $("#fielding").css('-webkit-animation-name', function() {
        return "sprite-standing-right";
      });
      break;
    case 40:
      $("#fielding").stop();
      $("#fielding").css('-webkit-animation-name', function() {
        return "sprite-standing-downward";
      });
      break;
  }
}
